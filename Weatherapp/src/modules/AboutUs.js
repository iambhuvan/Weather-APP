      ...
      <div className="container ">
        ...
        <div className="col-xl-3 col-sm-6 mb-5">
            <div className="shadow p-3 mb-5 bg-white rounded"><img src="https://www.terrainhopperusa.com/wp-content/uploads/2019/01/avatar-man.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
              <h5 className="mb-0">Nallamothu Bhuvan</h5><span className="small text-uppercase text-muted">Team Member</span>
             
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 mb-5">
            <div className="shadow p-3 mb-5 bg-white rounded"><img src="https://www.terrainhopperusa.com/wp-content/uploads/2019/01/avatar-man.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
              <h5 className="mb-0">Ch. Lokesh</h5>
          ...
          <div className="col-xl-3 col-sm-6 mb-5">
            <div className="shadow p-3 mb-5 bg-white rounded"><img src="https://www.terrainhopperusa.com/wp-content/uploads/2019/01/avatar-man.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
              <h5 className="mb-0">K.Deepesh</h5><span className="small text-uppercase text-muted">Team Member</span>
